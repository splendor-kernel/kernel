...
def main() -> int:
    ...
    negatives = [
        ...
        {"case": "physical_reserved_node_param_rejected", "passed": reserved_node_injection["status"] == 200 and reserved_node_injection["body"].get("status") == "Failed" and "acceptance_operation_reserved_field" in str(reserved_node_injection["body"].get("error", "")) and provider_effect_state(sim_before_reserved_node) == provider_effect_state(sim_after_reserved_node)},
