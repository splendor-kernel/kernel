...
pub use authority::{
    ...
    AuthorityObligationKind, AuthorityObligationReceipt, AuthorityOperation,
    ...
    CapabilityScope, DataPurpose, DelegationChain, DelegationGrant, DelegationResultContract,
