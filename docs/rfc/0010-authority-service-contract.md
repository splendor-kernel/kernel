...
- the additive `LegacyMultiScopeProfile` compatibility builder uses the existing
  ...
  empty/nil lists and invalid or wildcard-like audiences fail closed.
